...
const eventTypes = [
  ...
  },
  {
    ...
    description:
      "Office parties, launch dinners, wrap parties — a hibachi show is the team event people actually talk about after. Weekday dates get the $54.90/adult Weekday Special with a free appetizer of your choice (gyoza, edamame or spring rolls).",
  },
  {
