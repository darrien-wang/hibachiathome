...
export default function BookingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800 relative">
      ...
      <div className="container mx-auto px-4 pt-24 pb-12 mt-16 relative z-10">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            <h1 className="text-4xl font-bold mb-4 fire-text-gradient">Book Your Hibachi Experience</h1>
