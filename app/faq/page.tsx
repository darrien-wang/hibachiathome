...
export const metadata: Metadata = {
  ...
  keywords: "hibachi at home FAQ Los Angeles, hibachi catering questions LA, teppanyaki at home Orange County, hibachi chef booking questions, Hibachi Chef service FAQ",
  openGraph: {
