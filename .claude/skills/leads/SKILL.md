...
- **自动报价发过之后，人工跟进不再重复报价**（用户 09-19）：价格他手上已经有了，再报一遍像在催单。用跟进的姿态问需求——什么场合、几个人、那天有什么想法——一次最多两个问题。例："Hi Kris, it's Bling from Real Hibachi. Halloween weekend in Joshua Tree, nice. What's the occasion, and how many of you are going?"
