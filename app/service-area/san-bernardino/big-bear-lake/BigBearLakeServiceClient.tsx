...
export default function BigBearLakeServiceClient() {
  const cityData = getSBCityBySlug("big-bear-lake")
  ...
  return (
    <CityServiceTemplate
      ...
      description="Experience authentic hibachi at home in Big Bear Lake! Our professional Japanese teppanyaki chefs bring the excitement of hibachi grilling directly to your home, creating unforgettable dining experiences for families and celebrations."
