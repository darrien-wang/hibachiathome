// GENERATED 2026-09-18 by research/scripts/generate-city-travel.py — driving miles
...
export const cityTravel: Record<string, CityTravel> = {
  ...
  "beverly-hills": { miles: 30.6, fee: 0 }, // Beverly Hills
  "culver-city": { miles: 29.6, fee: 0 }, // Culver City
  "burbank": { miles: 29.2, fee: 0 }, // Burbank
  "thousand-oaks": { miles: 60.4, fee: 10 }, // Thousand Oaks
  "west-covina": { miles: 4.1, fee: 0 }, // West Covina
  "whittier": { miles: 9.0, fee: 0 }, // Whittier
  "arcadia": { miles: 13.2, fee: 0 }, // Arcadia
  "san-gabriel": { miles: 13.3, fee: 0 }, // San Gabriel
  "rowland-heights": { miles: 8.3, fee: 0 }, // Rowland Heights
  "diamond-bar": { miles: 12.3, fee: 0 }, // Diamond Bar
  "inglewood": { miles: 33.1, fee: 0 }, // Inglewood
  "malibu": { miles: 47.3, fee: 0 }, // Malibu
  "woodland-hills": { miles: 45.7, fee: 0 }, // Woodland Hills
  "san-diego": { miles: 113.4, fee: 63 }, // San Diego
  "irvine": { miles: 32.8, fee: 0 }, // Irvine
  "anaheim": { miles: 18.1, fee: 0 }, // Anaheim
  "long-beach": { miles: 32.9, fee: 0 }, // Long Beach
  "pasadena": { miles: 22.3, fee: 0 }, // Pasadena
  "santa-monica": { miles: 34.8, fee: 0 }, // Santa Monica
  "huntington-beach": { miles: 37.3, fee: 0 }, // Huntington Beach
  "riverside": { miles: 38.9, fee: 0 }, // Riverside
  "temecula": { miles: 69.7, fee: 20 }, // Temecula
  "santa-clarita": { miles: 53.4, fee: 3 }, // Santa Clarita
  "torrance": { miles: 35.4, fee: 0 }, // Torrance
  "newport-beach": { miles: 37.3, fee: 0 }, // Newport Beach
  "glendale": { miles: 27.5, fee: 0 }, // Glendale
  "corona": { miles: 31.8, fee: 0 }, // Corona
  "oceanside": { miles: 76.2, fee: 26 }, // Oceanside
  "palm-springs": { miles: 92.2, fee: 42 }, // Palm Springs
  "joshua-tree": { miles: 112.5, fee: 62 }, // Joshua Tree
  "big-bear-lake": { miles: 82.9, fee: 33 }, // Big Bear Lake
  "la-quinta": { miles: 112.1, fee: 62 }, // La Quinta
  "la-jolla": { miles: 104.7, fee: 55 }, // La Jolla
  "santa-barbara": { miles: 116.3, fee: 66 }, // Santa Barbara
  "idyllwild": { miles: 94.1, fee: 44 }, // Idyllwild
}
