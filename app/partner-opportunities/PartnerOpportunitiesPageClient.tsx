    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-red-50">
      <div className="hero-section bg-gradient-to-r from-amber-600 via-orange-600 to-red-600 text-white pb-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">Partner Opportunities</h1>
          <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
            We are looking for trusted local partners to help deliver exceptional hibachi experiences.
          </p>
          ...
          <div>
            <Card className="shadow-xl border-0 bg-white">
              <CardHeader className="bg-gradient-to-r from-amber-500 to-orange-500 text-white rounded-t-lg">
                ...
                <CardDescription className="text-amber-100">
                  Fill out the information below and we will contact you soon.
                </CardDescription>
              </CardHeader>
              <CardContent className="p-8">
                {submitStatus === "success" && (
                  <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg">
                    <p className="text-green-800">Thank you for your application. We will contact you within 24 hours.</p>
                  </div>
                )}
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      rows={5}
                      required
                      placeholder="Please describe your service offerings, experience, and pricing range."
                      className="focus:ring-orange-500 focus:border-orange-500"
                    />
                  </div>
            ...
            <div className="mt-8 grid gap-4">
              ...
              <div className="text-sm text-gray-600 italic mt-2">
                We are gradually opening other areas. Reach out if you serve nearby cities.
              </div>
            </div>
          </div>
        </div>
