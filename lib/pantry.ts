...
export const PACK_NOTES = [
  ...
  "虾 16/20：1 袋 = 43 只（09-24 实数，别再按 18 只/lb 估）；鸡蛋 36/盒",
  "西兰花 32oz 袋；胡萝卜 12oz 袋；三文鱼 Marketside 2lb 袋 = 5 块（只能整袋买，入库 1 袋 = 32 oz）",
  ...
  "按价推重量：金额 ÷ 单价（如鸡胸 $2.57/lb、西冷 $11.94/lb）；西冷按盒买（Walmart Top Sirloin Family Pack，**平均 1.6 lb/盒**，4-6 块，老板经验 1 盒 ≈ 4 人；盒数 = 选牛排人数 ÷ 4），入库仍按小票实重记 oz",
