...
- 1 lb = 16 oz；酱料 1 fl oz ≈ 2 tbsp；1 gal = 256 tbsp；Yum Yum 16oz 瓶 = 8 人份、姜汁酱 16oz 瓶 = 16 人份（09-24 定）
- 沙拉菜 1 份 = **1 oz**，RD 3 lb 袋 = 48 份；炒饭料 = 冻青豆胡萝卜（不是调味粉！），RD 12 oz 包 ≈ 30 人份，入库 1 包 = 24 tbsp；豆腐 16oz 盒 ≈ 3 人份；炒面用 pasta，RD 10 lb/箱；毛豆 12oz 袋 = **1 份**，1 份喂 3 人（09-24 定：份=袋，点几份带几袋；沙拉仍是老板定的）
- 煎饺 46.5oz ≈ 40 个、春卷 24.5oz ≈ 8 个、黄油 1 盒 = 2 根 × 8oz = 32 tbsp（每人 0.5 oz，按根带，09-24 定）
- 虾 16/20：1 袋 = 43 只（09-24 实数）；龙虾尾 1 盒 = 2 只；带子 1 个 ≈ 1 oz、每人 4 个；RD 5 lb/袋 ≈ 20 人份；鸡蛋 combo 装 2 盒一提 = 36 个（一起买）；清酒 1 箱 = 18 L
- 三文鱼 Marketside 2lb 真空袋 = **5 块**（只能整袋买，入库 1 袋 = 32 oz，09-24 定）
- 平均盒重（没小票单价时用，09-24 定）：鸡胸盘 ≈**4.5 lb/盒**；菲力 ≈**0.6 lb/盒**（≈2 人份）；西冷 Top Sirloin Family Pack ≈**1.6 lb/盒**，经验 1 盒 ≈ 4 个选牛排的客人（盒数 = 人数 ÷ 4）
