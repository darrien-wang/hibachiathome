...
export const EXTRA_OCCASIONS: OccasionPage[] = [
  ...
  },
  {
    ...
    intro: [
      ...
      "Weekday events are our sweet spot: Monday–Thursday bookings get the $54.90/person Weekday Special with a free appetizer platter and free tables & chairs, and daytime slots are usually easy to get.",
    ],
    moments: [
      {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Monday–Thursday events get the Weekday Special at any party size: $54.90/person instead of $59.90, plus a free appetizer platter and free tables & chairs. Same food, same show — corporate events are exactly what that rate is for.",
      },
      PRICE_FAQ,
    ],
  },
