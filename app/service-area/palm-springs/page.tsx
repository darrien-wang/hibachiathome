...
export const metadata: Metadata = {
  ...
  keywords: "hibachi at home Palm Springs, teppanyaki chef desert, Japanese chef Palm Desert, hibachi catering Rancho Mirage, private chef La Quinta, hibachi party Coachella Valley",
  openGraph: {
