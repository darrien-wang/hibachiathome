...
export const metadata: Metadata = {
  ...
  keywords: "hibachi at home Monrovia, teppanyaki chef Monrovia, Japanese chef Monrovia, hibachi catering Monrovia, private chef Monrovia, hibachi party Monrovia",
  openGraph: {
