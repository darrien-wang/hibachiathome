...
export const metadata: Metadata = {
  ...
  keywords: "hibachi at home Inglewood, teppanyaki chef Inglewood, Japanese chef Inglewood, hibachi catering Inglewood, private chef Inglewood, hibachi party Inglewood",
  openGraph: {
