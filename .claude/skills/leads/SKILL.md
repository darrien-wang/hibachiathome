...
- **Kosher**：能做的是**买 kosher 认证的肉，不加价**（用户 09-24 定）。**天花板就到这里**——铁板、餐具、流程没有拉比监督，不是全程 kosher。**客人不问就不提这个边界**（§1.05）；他直接问监督/证书/全程 kosher，就如实说我们只做到肉是认证的。首例：Shiran Ross 818-331-2940，LA 90020，16 大 3 小。
