...
export const metadata: Metadata = {
  ...
  keywords: "hibachi at home Alhambra, teppanyaki chef Alhambra, Japanese chef Alhambra, hibachi catering Alhambra, private chef Alhambra, hibachi party Alhambra",
  openGraph: {
