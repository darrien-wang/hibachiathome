      ...
      <div className="relative bg-white p-4 sm:p-6 rounded-lg shadow-lg w-full max-w-2xl max-h-[90vh] sm:max-h-[80vh] overflow-y-auto mx-2">
        ...
        <div className="prose prose-sm space-y-6">
          <div>
            ...
            <p>
              Real Hibachi LLC, or any agent, employee, director, or representative of Real Hibachi LLC, will NOT be
              liable to any Licensee (Host) or Licensee's guests for property damage caused as a result of any party
              held on the Licensee's (Hosts) premises. For the purpose of this paragraph "property damage" is defined
              as: injury to any real or personal property on the premises of where the Real Hibachi event is taking
              place. Furthermore, Licensee (Host), individually and for Licensee's guests, waives any claim against Real
              Hibachi LLC for any loss of, or damage or destruction to, property of Licensee (Host) or Licensee's
              guests, arising from any cause. This waiver is intended to be a complete release of any responsibility for
              property loss or damage or destruction to the property sustained by the Licensee or Licensee's guests
              before, during, or after the Real Hibachi LLC. event has taken place.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <p>
              ...
              refund. Inside 72 hours we may not be able to refund in full. Cooking is outdoors, so if rain is possible we recommend putting a 10&apos;x10&apos; pop-up tent over the
          ...
          <div>
            ...
            <p>
              PLEASE NOTE: The Following Locations Require A Travel Fee And/ Or Larger Minimum. 1 Travel Fee Per Chef.
            </p>
