...
export const PACK_NOTES = [
  ...
  "按价推重量：金额 ÷ 单价（如鸡胸 $2.57/lb、西冷 $11.94/lb）；鸡胸盘平均 4.5 lb/盒、菲力 ≈0.6 lb/盒 ≈ 2 人份（用户 09-24 定，没小票时用）；西冷按盒买（Walmart Top Sirloin Family Pack，**平均 1.6 lb/盒**，4-6 块，老板经验 1 盒 ≈ 4 人；盒数 = 选牛排人数 ÷ 4），入库仍按小票实重记 oz",
