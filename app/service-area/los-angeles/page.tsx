...
export const metadata: Metadata = {
  ...
  keywords: "hibachi at home Los Angeles, teppanyaki chef LA, Japanese chef Beverly Hills, hibachi catering Santa Monica, private chef Pasadena, hibachi party Los Angeles County",
  openGraph: {
